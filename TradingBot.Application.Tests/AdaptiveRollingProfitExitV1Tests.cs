...
public class AdaptiveRollingProfitExitV1Tests
{
    ...
    public void Settings_EarlyLossCut_DefaultsAreSafe()
    {
        ...
        // Projected-net loss floor must scale with notional: 10bps of 15000 = 15 USDT.
        Assert.Equal(15m, settings.EarlyLossCutProjectedNetFloor(15_000m));
        // And never fall below the absolute minimum on small positions.
        Assert.Equal(1.50m, settings.EarlyLossCutProjectedNetFloor(100m));
    }
