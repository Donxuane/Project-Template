-- 014_add_adaptive_rolling_profit_exit_v1.sql
--
-- Purpose: Add restart-safe persistence for AdaptiveRollingProfitExitV1:
--          account-specific futures fee history, per-position rolling state/high-water
--          marks, sampled microstructure/PnL decisions, and read-only counterfactuals.
--
-- Safety: additive, idempotent. No changes to entry rules. No live-order enablement.
